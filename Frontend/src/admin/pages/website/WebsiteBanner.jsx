    ...
    <div className="p-2">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 sm:mb-8 gap-4 sm:gap-0">
        <h2 className="text-xl sm:text-2xl font-bold text-gray-900">
          Banner <span className="text-orange-500">Manager</span>
        </h2>
        <button
          onClick={() => setShowUploadForm(!showUploadForm)}
          className="flex items-center gap-2 px-4 py-2 bg-white text-orange-500 border border-orange-500 rounded-lg hover:bg-orange-500 to-[#31155a] hover:text-white font-semibold hover:border-none"
        >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 sm:p-6">
          <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-xl w-full max-w-md relative">
            ...
            <button
              ...
              className="absolute top-4 sm:top-6 right-4 sm:right-6 text-orange-500 hover:text-orange-600 transition"
            >
              <X size={20} />
            </button>
            ...
            <button
              ...
              className="mt-4 w-full sm:w-auto px-3 py-2 rounded-lg shadow-lg bg-orange-500 text-white transition flex justify-center items-center gap-2"
            >
              <Upload size={16} />
              Upload
            </button>
          ...
          banners.map((banner) => (
            ...
            >
              <img
                src={banner.image}
                alt="Banner"
                className="w-full h-48 sm:h-56 md:h-64 lg:h-52 xl:h-60 object-contain rounded-xl"
              />
              <button
